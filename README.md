...
I use this library as a tool to develop toy implementations of such solvers mainly to visualize and understand implementation details which are usually omitted in their respective papers.
